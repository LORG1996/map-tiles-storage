import{Bc as e,Pl as t,Vc as n}from"./index-BWQv8qGT.js";var r,i,a;t((()=>{n(),r=`gaussianSplattingVoxelPixelShader`,i=`var voxel_storage: texture_storage_3d<r8unorm,write>;varying vNormalizedPosition: vec3f;varying vNormalizedCenterPosition: vec3f;varying vAlpha: f32;varying vPatchPosition: vec2f;fn gsVoxelPrngCanonical1d(co: f32)->f32 {return fract(sin(co*91.3458)*47453.5453);}
...
`,e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=i),a={name:r,shader:i}}))();export{a as gaussianSplattingVoxelPixelShaderWGSL};