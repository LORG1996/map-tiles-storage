import{Bc as e,Vc as t}from"./index-Buozv6rz.js";t();var n=`msdfVertexShader`,r=`#define BILLBOARD 1
...
atlasUV=vec2(uvs.x+offsets.x*uvs.z,uvs.y+(1.0-offsets.y)*uvs.w);}`;e.ShadersStore[n]||(e.ShadersStore[n]=r);var i={name:n,shader:r};export{i as msdfVertexShader};